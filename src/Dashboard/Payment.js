...
const Payment = () => {
    ...
    const url = `https://ancient-chamber-96068.herokuapp.com/booking/${id}`;
        ...
        <div>
            ...
            <div class="card w-50 max-w-md bg-base-100 shadow-xl my-12">
                <div class="card-body">
                    ...
                    <p>We will see you on <span className='text-orange-700'>{appointment.date} at </span> <span>{appointment.slot}</span></p>
